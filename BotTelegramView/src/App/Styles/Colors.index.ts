...
export const LIGHT_GRAY: string = '#515151'

export const LIGHT_GRAY_TABLE: string = '#626262'

export const RED_ALERT: string = '#FF5555'

export const SUTIL_GRAY: string =  '#D2CFC5'

export const LIGHT_ORANGE:string = '#ff7a33'

export const ORANGE: string = '#ff5900'

export const DARK_ORANGE: string = '#b23e00'